...
Fonte: https://github.com/leonardomso/33-js-concepts
...
## 6. Expressão vs Instrução(Expression vs Statement)
...
## 8. Fila de Mensagens e Loop de Eventos(Message Queue e Event Loop)
...
## 9. setTimeout, setInterval e requestAnimationFrame
...
## 10. Mecanismos JavaScript(JavaScript Engines)
...
## 11. Dom e Árvores de layout(DOM e Layout Trees)

[DOM Tree](https://javascript.info/dom-nodes)

## 12. Fábricas e Classes(Factories e Class)
...
## 14. new, Constructor, instanceof e Instances
...
## 15. Herança de protótipo e cadeia de protótipos(Prototype Inheritance e Prototype Chain)
...
## 16. Object.create e Object.assign
...
## 18. Funções puras, efeitos colaterais e mutação de estado(Pure Functions, Side Effects e State Mutation)
...
## 20. Funções de alta ordem (Higher Order Functions)
...
## 25. Estrutura dos dados(Data Structures)
...
## 26. Expensive Operation e Big O Notation
...
## 28. Herança, Polimorfismo e Reutilização de Código(Inheritance, Polymorphism and Code Reuse)
...
## 29. Padrões de design(Design Patterns)
...
## 30. Parciais, Currying, Compose e Pipe
